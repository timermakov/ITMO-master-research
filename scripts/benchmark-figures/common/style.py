...
SCENARIO_DESCRIPTIONS = {
    "s0-control": "Без прогрева: холодный инстанс сразу получает первый боевой запрос.",
    ...
    "h4-mirror-off": "Зеркалирование выключено: базовая задержка active path через proxy.",
    "h4-mirror-on": "Зеркалирование включено: active path при асинхронном shadow-трафике.",
}
